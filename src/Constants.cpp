...
int Constants::SCREEN_WIDTH = 800;
int Constants::SCREEN_HEIGHT = 600;
const char * Constants::APP_NAME = "Quarri";
int Constants::CAMERA_MOVE_AMOUNT = 25;

int Constants::PLAYER_SIZE = 25;
int Constants::PLAYER_HEIGHT = 19;
int Constants::PLAYER_BOTTOM = 3;
int Constants::PLAYER_BACK = 6;
int Constants::SCREEN_BOTTOM = 6;
int Constants::SCREEN_TOP = 16;
int Constants::BOX_SPACE = 3;
int Constants::SHADE_WIDTH = 3;
int Constants::TIRE_RADIUS = 2;
int Constants::EYE_WIDTH = 1;

int Constants::FLAG_BASE_HEIGHT = 5;
int Constants::FLAG_POLE_WIDTH = 5;
